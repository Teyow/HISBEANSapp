    ...
    <div class="container">
        ...
        <div class="flex justify-center">
            <div class="uk-card uk-card-default uk-card-body ml-5 mr-5 mt-10 rounded-xl  w-3/5">
                ...
                <form action="{{ route('updatePromo', $promos->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class=" uk-placeholder uk-text-center h-20">
                        <input type="file" name="image" value="{{ $promos->image_path }}">
                    </div>
                    <div class="uk-margin">
                        <input class="uk-input" type="text" placeholder="Name" aria-label="Input" name="name"
                            value="{{ $promos->name }}" required>
                    </div>
                    <div class="uk-margin">
